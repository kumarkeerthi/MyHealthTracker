...
ALTER TABLE exercise_entries
    ...
    ADD COLUMN IF NOT EXISTS muscle_group VARCHAR(100) DEFAULT 'full_body',
    ADD COLUMN IF NOT EXISTS grip_intensity_score FLOAT DEFAULT 0,
    ADD COLUMN IF NOT EXISTS pull_strength_score FLOAT DEFAULT 0,
    ADD COLUMN IF NOT EXISTS progression_level INTEGER DEFAULT 1,
    ADD COLUMN IF NOT EXISTS dead_hang_duration_seconds INTEGER,
    ADD COLUMN IF NOT EXISTS pull_up_count INTEGER,
    ADD COLUMN IF NOT EXISTS assisted_pull_up_reps INTEGER,
    ADD COLUMN IF NOT EXISTS grip_endurance_seconds INTEGER,
...
ALTER TABLE vitals_entries
    ...
    ADD COLUMN IF NOT EXISTS hr_zone_1_minutes INTEGER DEFAULT 0,
    ADD COLUMN IF NOT EXISTS hr_zone_2_minutes INTEGER DEFAULT 0,
    ADD COLUMN IF NOT EXISTS hr_zone_3_minutes INTEGER DEFAULT 0,
    ADD COLUMN IF NOT EXISTS hr_zone_4_minutes INTEGER DEFAULT 0,
    ADD COLUMN IF NOT EXISTS hr_zone_5_minutes INTEGER DEFAULT 0,
